...
function initializeMouseEffect() {
  ...
  function updateRectangle(event) {
    ...
    const scaleFactorX =
      1 + Math.pow(distanceFromCenterX / maxDistanceX, 2) * 2; // Magnify the center, compress the edges
    const scaleFactorY =
      1 + Math.pow(distanceFromCenterY / maxDistanceY, 2) * 2; // Magnify the center, compress the edges
